...
public class PojoJsonPlace {
    ...
    // 1) Tum variable’lari (key'ler)  "private" olarak olusturalim
    // 2) Tum variable’lar icin getter() and setter() metodlari olusturalim --sagtus--Generate-- Getter and Setter--hepsinisec--ok
    // 3) Tum parametreleri iceren bir constructor olusturalim ---sagtus--Generate-- Constructor--hepsinisec--ok
    // 4) Default constructor (parametresiz) olusturalim--sagtus--Generate-- Constructor-seciliolan--Select None tikla
    // 5) toString() metodu olusturalim--sagtus--Generate-- toString-hepsinisec--ok
